...
import com.auth.modal.user.UserVerification;
import com.auth.service.UserService;
import com.auth.service.UserVerificationService;
...
public class RegistrationCompleteEventListener implements ApplicationListener<RegistrationCompleteEvent> {
    ...
    public void onApplicationEvent(RegistrationCompleteEvent event) {
        UserVerification userVerification = userVerificationService.creteNewUserVerification(userService.toUser(event.getUser()));
