...
import com.auth.event.ForgetPasswordEvent;
import com.auth.modal.user.UserForgetPassword;
import com.auth.service.UserForgetPasswordService;
...
public class ForgetPasswordEventListener implements ApplicationListener<ForgetPasswordEvent> {
    ...
    public void onApplicationEvent(ForgetPasswordEvent event) {
        UserForgetPassword userForgetPassword = userForgetPasswordService.creteNewUserForgetPassword(userService.toUser(event.getUser()));
